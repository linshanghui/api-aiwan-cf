...
<!-- </div> -->
            ...
            <div class="main-left">
                ...
                <div class="main-left-n">
                    ...
                    for ($i = 0; $i < $icon; $i++) {
                        ...
                        <!--a href="https://space.bilibili.com/182936378">
                            <i class="iconfont icon-bilibili-fill"></i>
                        </a>
                        <a href="http://master.suvvs.com">
                            <i class="iconfont icon-zuanshi1"></i>
                        </a>
                        <a href="http://wpa.qq.com/msgrd?v=3&uin=2517270540&site=qq&menu=yes">
        ...
        <!--版权申明-->
        <div class="Copyright">
            <p>© <?php echo date('Y');?> <a href="https://www.yy0228.cn">小新</a>. All rights reserved.</p>
